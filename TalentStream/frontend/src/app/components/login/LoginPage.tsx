      ...
      >
         ...
         <div className="flex flex-col items-center mb-8">
            <div className="flex items-center gap-3 mb-6">
               ...
               <span className="text-xl font-semibold tracking-tight" style={{ color: 'white' }}>TalentStream</span>
            </div>
            <h2 className="text-[15px] font-medium mb-1" style={{ color: '#94a3b8' }}>Welcome back to</h2>
            <h1 className="text-xl font-bold tracking-tight" style={{ color: 'white' }}>TalentStream Precision</h1>
         </div>
